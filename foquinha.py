...
cor = ["AZUL", "LARANJA", "ROXO", "VERDE", "VERMELHO", "AMARELO", "PRETO", "BRANCO", "CINZA", "MARROM", "BEGE", "TURQUESA", "DOURADO", "PRATA"]
...
while True:
    ...
    vida = 8
    print("--------------------------------")
    print(f"Vamos jogar o jogo da forca, você só tem 8 vidas :), o genero é:")
    print()
    print("  " + genero_str)
    print()
    mostrar()
